          ...
          <ScrollReveal>
            <div className="text-center mb-14">
              ...
              <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
                ...
                industrial operations, from equipment supply to expert
                consultancy.
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <ScrollReveal direction="right">
              ...
              >
                ...
                targeted training, we deliver results that matter. Backed by one
                of Qatar's leading law firms, we also provide expert legal
                support to protect and grow your enterprise.
              </p>
