...
const services = [
  {
    ...
    desc: "We supply a wide range of equipment and machinery—both new and certified pre-owned—with comprehensive warranty coverage and reliable after-sales service.",
    image: "/images/phoenix-products.jpg",
  },
  {
    icon: <Wrench className="w-10 h-10" />,
    title: "Service & Maintenance",
    desc: "Our industry-specialized teams manage preventive and corrective maintenance programs, ensuring maximum uptime and operational efficiency.",
    image: "/images/phoenix-service.jpg",
  },
  {
    icon: <Globe className="w-10 h-10" />,
    title: "Spare Parts & Consumables",
    desc: "Partnered with world-leading manufacturers of genuine and OEM spare parts, ensuring extended asset life backed by warranty.",
    image: "/images/spare_parts_consumables.jpeg",
  },
  {
    icon: <Users className="w-10 h-10" />,
    title: "Logistics & Delivery",
    desc: "Through partnerships with leading logistics providers across air, sea, and road, we ensure seamless delivery worldwide.",
    image: "/images/logistics_delivery.jpeg",
  },
  {
    icon: <Award className="w-10 h-10" />,
    title: "Eco-Matrix Systems",
    desc: "Diversified, industry-specific waste management solutions integrating ecological responsibility with economic efficiency.",
    image: "/images/eco-matrix.jpg",
  },
  {
    icon: <Briefcase className="w-10 h-10" />,
    title: "Consultancy Services",
    desc: "Smart solutions that optimize operations, reduce costs, enhance asset reliability, and minimize breakdowns.",
    image: "/images/consultancy_services.jpeg",
  },
];
...
const features = [
  {
    ...
    desc: "Over 20 years of proven expertise across oil & gas, industrial, marine, and HVAC sectors.",
  },
  {
    icon: <Shield className="w-8 h-8" />,
    title: "Quality Assured",
    desc: "ISO 9001, 14001, and 45001 certified for consistent quality, safety, and environmental standards.",
  },
  {
    icon: <Globe className="w-8 h-8" />,
    title: "Global Network",
    desc: "Strong global partnerships and expanding service infrastructure worldwide.",
  },
  {
    icon: <Users className="w-8 h-8" />,
    title: "24/7 Support",
    desc: "Round-the-clock service and technical support ensuring reliability when it matters most.",
  },
  {
    icon: <Award className="w-8 h-8" />,
    title: "Expert Team",
    desc: "Skilled professionals dedicated to delivering exceptional results and tailored solutions.",
  },
  {
    icon: <Wrench className="w-8 h-8" />,
    title: "Trusted Reliability",
    desc: "A proven track record of success protecting critical assets across all industrial sectors.",
  },
];
...
const testimonials = [
  {
    ...
    text: "Phoenix Energy Group has been our trusted partner for over 5 years. Their expertise in oil & gas equipment and 24/7 support is unmatched in the region.",
  },
  {
    name: "Sarah Mitchell",
    role: "Project Manager",
    company: "Qatar Construction Co.",
    text: "The quality of equipment and the reliability of their service has significantly improved our project timelines. Highly recommended for construction needs.",
  },
  {
    name: "Mohammed Hassan",
    role: "Plant Manager",
    company: "Industrial Solutions LLC",
    text: "Their consultancy services helped us reduce maintenance costs by 30%. The team's expertise and dedication is truly exceptional.",
  },
];
  ...
  return (
    <div>
      ...
      <section className="relative h-[600px] md:h-[700px] lg:h-[90vh] overflow-hidden">
        {heroSlides.map((slide, i) => (
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to right, hsla(220, 20%, 8%, 0.88), hsla(220, 20%, 8%, 0.45))",
              }}
            />
          </div>
        ))}
            ...
            <div className="max-w-2xl">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <h2
                    className="font-heading text-4xl md:text-5xl lg:text-7xl font-bold leading-tight mb-2"
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-20 flex items-center gap-4">
          <button
            ...
            className="w-12 h-12 rounded-full border-2 border-primary/40 flex items-center justify-center hover:bg-primary hover:border-primary transition-all duration-300"
            style={{ color: "hsl(0, 0%, 100%)" }}
          >
          ...
          <div className="flex gap-3">
            {heroSlides.map((_, i) => (
              <button
                ...
                className={`w-3.5 h-3.5 rounded-full transition-all duration-300 ${i === currentSlide ? "bg-primary scale-110" : "bg-white/30 hover:bg-white/50"}`}
              />
            ))}
          </div>
          <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal direction="left">
              ...
              <h2 className="section-heading mb-6">
                Empowering Progress Across Industries
              </h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
                Driving Excellence and Efficiency Across Every Area We Touch
                since 2007, in 10+ countries and 7 critical industrial sectors.
              </p>
              <div className="space-y-5 mb-8">
                {[
                  {
                    title: "Markets & Industries",
                    desc: "Global Reliability for the World's Most Demanding Environments, with precision.",
                  },
                  {
                    title: "Products & Services",
                    desc: "Superior Sourcing and Engineering for Uninterrupted Operations.",
                  },
                  {
                    title: "Technology-savvy",
                    desc: "Advanced Engineering. Innovative Systems. We Get it Done.",
                  },
                ].map((item, i) => (
            ...
            <ScrollReveal direction="right">
              <div className="relative">
                <img
                  src="/images/phoenix-team.jpg"
                  alt="Phoenix Energy Group team"
                  className="w-full shadow-2xl"
                />
                <Link
                  to="/about#ceo-message"
                  className="absolute -bottom-8 -left-8 bg-primary p-8 shadow-xl hidden md:block hover:bg-primary/90 transition-colors group"
                >
                  <p className="text-primary-foreground text-sm leading-relaxed max-w-xs font-semibold">
                    "Driving Progress Across Borders — The Phoenix Commitment to
                  ...
                  <div className="mt-4 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-primary-foreground/80 text-xs group-hover:underline">
                        Phoenix Energy Global →
                      </p>
                    </div>
                  </div>
                </Link>
              ...
              <ScrollReveal key={service.title} delay={i * 100}>
                <div className="service-card group h-full flex flex-col">
                  ...
                  <div className="p-7 flex-1 flex flex-col">
                    ...
                    <Link
                      to="/services"
                      className="text-primary text-sm font-semibold flex items-center gap-2 hover:gap-3 transition-all uppercase tracking-wider"
                    >
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal direction="left">
              ...
              <p className="text-primary font-heading text-lg font-semibold mb-6">
                Without Compromising Efficiency
              </p>
              <p className="text-muted-foreground leading-relaxed mb-6">
                With Phoenix Consultancy, efficiency meets strategy. We
                streamline operations, cut costs, boost asset reliability, and
                prevent breakdowns—empowering your business to perform at its
                peak. From strategic sourcing and maintenance planning to
                targeted training, we deliver results that matter.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-8">
                Backed by one of Qatar's leading law firms, we also provide
            ...
            <ScrollReveal direction="right">
              <div className="relative">
                <img
                  src="/images/phoenix-team.jpg"
                  alt="Phoenix Consultancy Team"
                  className="w-full shadow-2xl"
                />
                <div className="absolute -bottom-6 -right-6 bg-primary p-6 shadow-xl hidden md:block">
                  <p className="text-primary-foreground font-heading text-lg font-bold">
      ...
      >
        <div
          className="absolute inset-0"
          style={{ background: "hsla(220, 20%, 8%, 0.92)" }}
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <ScrollReveal direction="left">
              ...
              >
                ...
                tailored solutions for your oil & gas, industrial, marine, or
                HVAC needs.
              </p>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal direction="left">
              ...
              <div className="section-divider" />
              <h2 className="section-heading-light mb-6">
                Your Trusted Partner in Quality, Performance, and Asset
                Protection
              </h2>
              <p
                ...
                style={{ color: "hsl(220, 10%, 70%)" }}
              >
                Phoenix Energy Group is proud to deliver products and services
                to the highest possible standards, and maintains an ongoing
              ...
              >
                Supported by a strong global network, extensive resources, and
                an expanding service infrastructure, we are well positioned to
                support and protect your critical assets.
              </p>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4">
            {[
              ...
              <div
                key={i}
                className="py-10 px-6 text-center border-r border-primary-foreground/10 last:border-r-0"
              >
                <CountUp end={stat.value} suffix={stat.suffix} />
                <p className="text-primary-foreground/80 text-sm uppercase tracking-wider mt-2">
                  {stat.label}
                </p>
              </div>
            ))}
